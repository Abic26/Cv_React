...
export const ProyectosComponents = () => {
  const data = [
    ...
    },
    {
      ...
      github: (
        <a
          href="https://github.com/Abic26/ToDoAbic"
          target="_blank"
        >
          <FaGithub size={30} />
        </a>
    ...
    },
    {
      ...
      github: (
        <a
          href="https://github.com/Abic26/Bou_in_Style_Page"
          target="_blank"
        >
          <FaGithub size={30} />
        </a>
    ...
    },
    {
      ...
      title: "Mas Proyectos",
      text: "Aca podras ingresar a mi repositorio de Github donde vas a poder encontrar mis proyectos y sus respectivos codigos.",
      github: (
        <a
